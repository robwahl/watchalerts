...
namespace iSpyApplication
{
    ...
    {
        private readonly IMediaPlayerFactory _mFactory;
        private readonly IDiskPlayer _mPlayer;
        ...
        private void EventsMediaEnded(object sender, EventArgs e)
        {
            UISync.Execute(InitControls);
        }
        ...
        private void EventsTimeChanged(object sender, MediaPlayerTimeChanged e)
        {
        ...
        private void EventsStateChanged(object sender, MediaStateChange e)
        {
        ...
        private void EventsDurationChanged(object sender, MediaDurationChange e)
        {

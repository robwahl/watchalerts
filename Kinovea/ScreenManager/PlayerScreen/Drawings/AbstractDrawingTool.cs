...
namespace Kinovea.ScreenManager.PlayerScreen.Drawings
{
    public abstract class AbstractDrawingTool
    {
        ...
        /// </summary>
        public abstract bool KeepTool { get; }

        /// <summary>
        ///     Whether we should stay on the same tool when the video moves forward.
        /// </summary>
        public abstract bool KeepToolFrameChanged { get; }

        /// <summary>
        ///     Current style preset
        /// </summary>
        public abstract DrawingStyle StylePreset { get; set; }

        /// <summary>
        ///     Default style preset
        /// </summary>
        public abstract DrawingStyle DefaultStylePreset { get; }
        ...
        /// </summary>
        /// <param name="origin">The image coordinates the drawing should be initialized with</param>
        /// <param name="iTimestamp">The time position where the drawing is added</param>
        /// <param name="averageTimeStampsPerFrame"></param>
        /// <returns>A new drawing object</returns>
        public abstract ScreenManager.PlayerScreen.Drawings.AbstractDrawing GetNewDrawing(Point origin, long iTimestamp,
            long averageTimeStampsPerFrame);

        /// <summary>
        ///     Retrieve the cursor we should dispaly when this tool is the active tool.
        /// </summary>
        /// <param name="fStretchFactor">Current stretchfactor (including zoom)</param>
        /// <returns>The cursor to use</returns>
        public abstract Cursor GetCursor(double fStretchFactor);
        ...
        #endregion Public Concrete Methods
    }
}
...
namespace Kinovea.ScreenManager
{
    partial class PlayerScreenUserInterface
    {
        ...
        private Button buttonGotoLast;
        private Button buttonGotoFirst;
        private Button buttonGotoPrevious;
        private Button buttonGotoNext;
        private Panel panelDebug;
        public Label dbgDrops;
        private Button buttonPlayingMode;
        private Button PrimarySelection;
        private Label lblSelDuration;
        private GroupBox groupBoxSpeedTuner;
        private Button markerSpeedTuner;
        private Label lblSelStartSelection;
        private ToolTip toolTips;
        private Label lblTimeCode;
        private Label dbgDurationTimeStamps;
        private Label dbgFFps;
        private Label dbgCurrentPositionAbs;
        private Label dbgSelectionDuration;
        private Label dbgSelectionEnd;
        private Label dbgSelectionStart;
        private Label dbgStartOffset;
        private Label dbgCurrentPositionRel;
        private Button btnClose;
        private Label lblFileName;
        private Button btn_HandlersLock;
        private Label lblSpeedTuner;
        private FrameTracker trkFrame;
        private SelectionTracker trkSelection;
        private Button btnSnapShot;
        private Label ImageResizerSE;
        private Label ImageResizerSW;
        private Label ImageResizerNE;
        private Label ImageResizerNW;
        private Label lblWorkingZone;
        private Label dbgDurationFrames;
        private Label dbgCurrentFrame;
        public PictureBox pbSurfaceScreen;
        private Button btnSetHandlerRight;
        private Button btnSetHandlerLeft;
        private Label dbgAvailableRam;
        private SplitContainer splitKeyframes;
        private PictureBox pictureBox1;
        private Panel pnlThumbnails;
        private SpeedSlider sldrSpeed;
        private Button btnDockBottom;
        private Button btnRafale;
        private Button btnHandlersReset;
        private Button btnDiaporama;
        private ToolStrip stripDrawingTools;

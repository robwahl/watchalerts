...
namespace Kinovea.ScreenManager
{
    partial class ThumbListView
    {
        ...
        private SplitContainer splitResizeBar;
        private Button btnClose;
        private Label lblZoomTuner;
        private Button btnHideThumbView;
        private Button btnExtraSmall;
        private Button btnLarge;
        private Button btnMedium;
        private Button btnSmall;
        private Button btnExtraLarge;
        private ToolTip toolTip1;
        private BackgroundWorker bgThumbsLoader;
    }
}
